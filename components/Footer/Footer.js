		...
		<div className={styles.footer}>
			<div className={styles.footer_logo}>
				...
				<div id={styles.footer_icons}>
					<a href="https://www.instagram.com/daksh2k22/?hl=en" target="_blank" rel="noreferrer">
						<AiOutlineInstagram className={styles.footer_icon} />
					</a>
					<a href="https://daksh-blog.medium.com/" target="_blank" rel="noreferrer">
						<AiFillMediumCircle className={styles.footer_icon} />
					</a>
					<a href="https://www.linkedin.com/company/dakshsastra/" target="_blank" rel="noreferrer">
						<RiLinkedinBoxFill className={styles.footer_icon} />
					</a>
					<a href="https://twitter.com/Daksh2k22" target="_blank" rel="noreferrer">
						<TiSocialTwitter className={styles.footer_icon} />
					</a>
					<a href="https://www.youtube.com/channel/UCiFKilPCc87fcbIRh_tiPQA" target="_blank" rel="noreferrer">
						<TiSocialYoutube className={styles.footer_icon} />
					</a>
					<a href="https://www.facebook.com/daksh.sastra" target="_blank" rel="noreferrer">

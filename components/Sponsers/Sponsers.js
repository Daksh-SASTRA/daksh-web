				...
				<Slider {...settings}>
					<div className={styles.sponsers__div} {...myDelay(3)}>
						<img
							...
							src="/sponsers/d2k23/psiog-logo.png"
							alt="sponser-1"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/Royal-Enfield.png"
							alt="sponser-2"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/Niutraan-Institute-of-Technology.jpg"
							alt="sponser-3"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/Kalwe logo social media.png"
							alt="sponser-4"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/gold cup.png"
							alt="sponser-5"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/Zapp_AdventurePartner.png"
							alt="sponser-6"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={`${styles.sponser_infinite} ${styles.blackBackground}`}
							src="/sponsers/d2k23/Drunken Monkey logo.png"
							alt="sponser-7"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/bookchor logo.jpeg"
							alt="sponser-9"
							width="250px"
							height="150px"
						/>
					...
					<div className={styles.sponsers__div}>
						<img
							className={styles.sponser_infinite}
							src="/sponsers/d2k23/cascade cafe logo.jpg"
							alt="sponser-8"
							width="250px"
							height="150px"
						/>
